...
The recommended method for installing torlib is by using `pip`_.

Installing from PyPi
--------------------

To install ChatterBot from `PyPi`_ using pip run the following command in your terminal.
...
1. Clone repository from GitHub. `git`_ is needed in this step.
